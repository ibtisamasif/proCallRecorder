package lvc.pro.com.pro.contacts;
...
import lvc.pro.com.pro.Main2Activity;
...
//                                info.setPhoto(photo);
    ...
    public static ArrayList<Contacts> getCallList(Context ctx, ArrayList<String> recordingList, String type) {
        ...
        PhoneContactsDatabase database = new PhoneContactsDatabase(ctx);
